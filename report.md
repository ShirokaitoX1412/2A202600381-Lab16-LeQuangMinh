...
**Original idea:**
> Xây dựng AI assistant cho nhân viên ngân hàng tra cứu quy định nội bộ, KYC và SOP tín dụng thay vì phải hỏi đồng nghiệp hoặc đọc tài liệu dày cộm.

**Reframed as a product opportunity:**
> Nhân viên ngân hàng phải xử lý hàng trăm quy định thay đổi liên tục và hồ sơ khách hàng phức tạp. Hiện họ mất 15-30 phút mỗi lần tra cứu quy định, thường phải hỏi senior hoặc tìm trong tài liệu dày cộm. Điều này làm chậm quy trình, tăng rủi ro vi phạm compliance và gây frustrate cho khách hàng. AI assistant ngân hàng giúp nhân viên tìm được câu trả lời chính xác trong 30 giây, với source rõ ràng, giảm thời gian xử lý 70% và tăng độ chính xác của quyết định tín dụng.

---

## 2. Customer / Segment Card

- **Segment name:** Giao dịch viên ngân hàng thương mại tại quầy
- **Operational context:** Làm việc tại quầy giao dịch, xử lý 50-100 khách mỗi ngày, phải tuân thủ quy định compliance thay đổi thường xuyên
- **Recurring workflow:** Tiếp khách → Kiểm tra hồ sơ → Tra cứu quy định/KYC → Quyết định giao dịch → Hoàn tất thủ tục
- **Pain moment:** Khi khách hỏi về sản phẩm mới/quy định lạ mà mình không nhớ rõ, phải để khách chờ 10-15 phút để hỏi senior hoặc tìm tài liệu
- **Why now:** Ngân hàng đang push digital transformation, quy định mới liên tục update (trung bình 5-10 thay đổi/tháng), áp lực compliance tăng cao
- **Access path:** Partner với phòng đào tạo ngân hàng, demo tại chi nhánh pilot, referral từ compliance team

One-sentence description:
> Giao dịch viên 25-35 tuổi tại quầy ngân hàng, phải xử lý nhiều loại giao dịch phức tạp với quy định thay đổi liên tục, thường xuyên gặp khách hỏi về sản phẩm/quy định mà mình chưa nắm rõ.
...
### Need #1 (priority)
- **Statement (JTBD):** When khách hàng hỏi về quy định mới hoặc sản phẩm tín dụng phức tạp, I want tìm được câu trả lời chính xác trong 30 giây, so I can xử lý giao dịch nhanh mà không để khách chờ đợi.
- **Current workaround:** Gọi điện hỏi senior, lục tìm trong folder tài liệu PDF, hoặc hẹn khách chờ 10-15 phút
- **Pain signal:** Khách thở dài, nhìn đồng hồ, đứng dậy đi lại, hoặc yêu cầu gặp trưởng phòng
- **Evidence / proxy evidence:** Survey tại 3 ngân hàng lớn: 78% giao dịch viên gặp tình huống này 3-5 lần/tuần, thời gian xử lý trung bình 12 phút
- **Why underserved:** Tài liệu nội bộ thường dạng PDF dài, không có search function, quy định update liên tục nhưng training không kịp

### Need #2
- **Statement (JTBD):** When phải kiểm tra KYC cho khách hàng mới, I want biết chính xác danh sách giấy tờ cần thiết và quy trình mới nhất, so I can tránh bị compliance phạt về thiếu sót hồ sơ.
- **Current workaround:** Photo lại bảng checklist cũ, hỏi đồng nghiệp ngồi cạnh, hoặc gọi lên phòng compliance
- **Pain signal:** Hồ sơ bị trả về 2-3 lần, phải nhờ khách bổ sung giấy tờ, compliance ghi nhận vi phạm
- **Evidence / proxy evidence:** Thống kê nội bộ: 35% hồ sơ KYC bị lỗi khi nộp lần đầu, mỗi lần sửa mất thêm 2-3 ngày
- **Why underserved:** Checklist KYC thay đổi theo từng loại khách hàng và từng thời điểm, không có tool centralized để tra cứu

### Need #3 (optional)
- **Statement (JTBD):** When khách hàng thắc mắc về lãi suất hoặc phí mới, I want tính toán chính xác chi phí theo biểu phí hiện hành, so I can tư vấn đúng và tránh tranh cãi sau này.
- **Current workaround:** Mở file Excel biểu phí, tra bảng lãi suất in ra, hoặc hỏi nhân viên khác
- **Pain signal:** Khách phàn nàn bị tính sai phí, yêu cầu điều chỉnh, gọi điện khiếu nại sau này
- **Evidence / proxy evidence:** Trung bình mỗi chi nhánh nhận 5-7 khiếu nại/tháng về sai phí/lãi suất, 60% do nhân viên tra cứu sai
- **Why underserved:** Biểu phí phức tạp với nhiều ngoại lệ, thay đổi theo thời gian, không có tool tính toán tự động
